...
import time #to see how long code takes to run
...
total_time = (end - start) *1000000 #convert to microseconds

print(f"The program took {total_time:,.2f} microseconds to run")
